// Controllers/AdminWitnessController.cs
...
[Route("Admin/Witness")]
public class AdminWitnessController : Controller
{
    private readonly IAdminWitnessService _service;

    public AdminWitnessController(IAdminWitnessService service) => _service = service;

    [HttpGet("Create/{caseId}")]
    public IActionResult Create(int caseId) => View(new WitnessFormViewModel { CaseId = caseId });

    [HttpPost("Create")]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Create(WitnessFormViewModel form)
    {
    ...
    [HttpPost("Edit/{id}")]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, WitnessFormViewModel form)
    {
